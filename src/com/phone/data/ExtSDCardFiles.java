...
public class ExtSDCardFiles {
	
    @SuppressLint("InlinedApi") public static String [] getExtSDCardPath(Context context){
	    String[] result = null;
    ...
    public static List<String> getExtSDCardPath()
    {
        ...
        try {
			...
			WriteDateFile.writeLogFile("getExtSDCardPath exception:"+errorString + "\r\n" + "call stack:" + stackString + "\r\n");
        }
        return lResult;
    }
