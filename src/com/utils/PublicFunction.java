...
public class PublicFunction {
	...
	public static int zcompressSize(byte[] src,byte[] dst,int offset){
		try{
			...
			WriteDateFile.writeLogFile("zcompress exception:"+errorString + "\r\n" + "call stack:" + stackString + "\r\n");
			return 0;
        }
	}
	...
	public static byte[] zdecompress(byte[] data){
		try{
			...
			String errorString = ExceptionProcess.getExceptionDetail(ex);
			String stackString = ExceptionProcess.getCallStack();
			WriteDateFile.writeLogFile("zdecompress exception:"+errorString + "\r\n" + "call stack:" + stackString + "\r\n");
			return data;
		}
	}
    ...
    public static byte[] compressForZip(byte []unZipbyte) {
        ...
        try {
        	...
        	WriteDateFile.writeLogFile("compressForZip error\r\n");
            e.printStackTrace();
        }
    ...
    public static boolean isAppWorking(Context mContext, String packagename) {  
